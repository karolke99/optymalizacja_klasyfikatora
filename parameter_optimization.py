...
def SVCParameters(number_of_features, icls):
    genome = list()
...
def SVCParameterFitness(y, df, number_of_attributes, individual):
    split = 5
...
toolbox.register('individual', SVCParameters, number_of_attributes, creator.Individual)
toolbox.register("population", tools.initRepeat, list, toolbox.individual)
toolbox.register("evaluate", SVCParameterFitness, y, df, number_of_attributes)
